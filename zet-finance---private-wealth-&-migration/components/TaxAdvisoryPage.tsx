         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {offerings.map((offer, idx) => (
               <div 
                 ...
                 className="bg-white p-10 rounded-sm shadow-xl border-t-4 border-brand-gold hover:-translate-y-2 transition-all duration-300 cursor-pointer group"
               >
                  ...
                  <div className="text-brand-navy font-bold text-sm uppercase tracking-widest flex items-center gap-2 group-hover:text-brand-gold transition-colors">
